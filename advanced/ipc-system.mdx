...
Partially updates an existing task. Only provided fields are changed. If the schedule changes, `next_run` is recomputed.
...
- Non-main groups can only update their own group's tasks
