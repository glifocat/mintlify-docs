...
<Steps>
  ...
  <Step title="Answer the wizard">
    ...
    2. **Sandbox image** — choose where the agent sandbox image comes from. The recommended default fetches the pre-built [Echo hardened image](/guides/echo-hardened-runtime): a quick browser sign-in to NanoClaw, then a large download that typically takes a few minutes. Or pick **Build it here** — no account, 3–10 minutes on a fresh machine.
