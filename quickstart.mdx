...
<Steps>
  ...
  <Step title="Run the installer">
    ...
    - Pairing your first channel (Telegram, Discord, WhatsApp, Signal, or the local CLI)
  ...
  <Step title="Answer the setup prompts">
    ...
    - **First channel** — Telegram, Discord, WhatsApp, Signal, or local CLI. You can add more later.
    - **Channel-specific auth** — bot token for Telegram/Discord, QR code for WhatsApp/Signal, nothing for CLI
