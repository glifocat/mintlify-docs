...
<Steps>
  ...
  <Step title="Answer the wizard">
    ...
    <Frame caption="The wizard right after the system check — the sandbox step that follows is the long one (a large image fetch that typically takes a few minutes, or a 3–10 minute local build).">
