...
<Steps>
  ...
  <Step title="Answer the wizard">
    ...
    <Frame caption="The wizard right after the system check — the sandbox build that follows is the long step (3–10 minutes on a first build).">
