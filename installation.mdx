...
```json
{
  "dependencies": {
    ...
    "grammy": "^1.39.3",           // Telegram Bot API (core channel)
...
<Note>
Telegram is included on `main` as a core channel. Other channel-specific dependencies (e.g., `@whiskeysockets/baileys` for WhatsApp, `discord.js` for Discord) are added when you install a channel skill.
</Note>
