...
{/* verified-against: .claude/skills/{add-gmail-tool,add-gcal-tool,add-ollama-tool,add-atomic-chat-tool}/SKILL.md, container/skills/agent-browser/SKILL.md, src/db/container-configs.ts, src/container-runner.ts @ 4e83a0a0 */}
