...
{/* verified-against: docs/skill-guidelines.md, docs/skill-directives.md, CONTRIBUTING.md, vitest.skills.config.ts, .claude/skills/{add-telegram,manage-mounts,update-skills,add-ollama-tool}/SKILL.md, .claude/skills/add-telegram/REMOVE.md @ 4e83a0a0 */}
