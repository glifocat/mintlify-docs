...
{/* verified-against: src/claude-md-compose.ts, src/group-persona.ts, src/container-runner.ts, src/cli/resources/groups.ts, container/agent-runner/src/providers/types.ts, container/skills/self-customize/SKILL.md, .claude/skills/customize/SKILL.md @ e926e30e (v2.1.53) */}
