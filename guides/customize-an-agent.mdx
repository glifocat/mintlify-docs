...
{/* verified-against: src/cli/resources/groups.ts, container/agent-runner/src/providers/types.ts, container/skills/self-customize/SKILL.md, .claude/skills/customize/SKILL.md @ 639577c3; project document: src/project-doc-compose.ts, src/group-persona.ts, src/container-runner.ts @ 294ef2ae */}
