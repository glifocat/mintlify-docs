...
{/* verified-against: setup/auto.ts, setup/registry-login.ts, setup/registry-login.sh, setup/registry.ts, setup/lib/registry-state.ts, container/Dockerfile, container/pull.sh, container/build.sh, setup/verify.ts, docs/hardened-image.md, versions.json @ 4446b5bd (main, #3150 merge). Auth screenshots are production captures (authenticate.nanoclaw.dev, 2026-07-29). */}
