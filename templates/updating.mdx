...
{/* verified-against: src/templates/restamp.ts, src/cli/resources/groups.ts, src/container-config.ts @ nanocoai/nanoclaw#3220 f8563abe; docs/templates.md @ nanocoai/nanoclaw#2909 ed19f8ea */}
...
```text
Restamp "sdr" → group "SDR Agent" (3f2c8a91-7b4d-4e1a-9c02-5f8ab6d31e77)
