...
{/* verified-against: src/templates/restamp.ts, src/cli/resources/groups.ts, src/container-config.ts @ nanocoai/nanoclaw#3220 1293ec56; docs/templates.md @ nanocoai/nanoclaw#2909 5df5800 */}
