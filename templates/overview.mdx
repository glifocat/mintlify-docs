...
{/* verified-against: src/templates/{parse,manifest,extension,mcp,skills,tasks,plugin-dir,create-agent,local-dir}.ts, src/cli/resources/groups.ts, docs/templates.md @ nanocoai/nanoclaw#3220 1293ec56; setup/{templates,auto}.ts @ nanocoai/nanoclaw#2909 5df5800; nanocoai/nanoclaw-templates @ 3c7966a7 */}
