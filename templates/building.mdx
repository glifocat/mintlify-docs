...
{/* verified-against: src/templates/{parse,manifest,extension,mcp,skills,tasks,plugin-dir,create-agent}.ts, src/container-config.ts, src/config.ts, container/agent-runner/src/plugin-mcp.ts, docs/templates.md @ nanocoai/nanoclaw#3220 1293ec56; nanocoai/nanoclaw-templates @ 3c7966a7 */}
