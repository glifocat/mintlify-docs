...
{/* verified-against: nanoclaw.sh, setup/{auto,templates}.ts, src/templates/{create-agent,local-dir}.ts, src/cli/resources/{groups,tasks}.ts @ nanocoai/nanoclaw#3220 1293ec56 + #2909 ed19f8ea; nanocoai/nanoclaw-templates @ 3c7966a7 */}
...
<CardGroup cols={2}>
<Card title="SDR Agent" icon="phone" href="https://github.com/nanocoai/nanoclaw-templates/tree/main/sales/sdr">
`sales/sdr` — researches prospects, enriches contacts, drafts outbound sequences, keeps the CRM clean. Uses HubSpot and Exa.
</Card>
<Card title="Competitor analysis" icon="binoculars" href="https://github.com/nanocoai/nanoclaw-templates/tree/main/product/competitor-analysis">
`product/competitor-analysis` — tracks competitors into structured docs, a news log, and a spreadsheet you can read.
</Card>
<Card title="Data analyst" icon="chart-line" href="https://github.com/nanocoai/nanoclaw-templates/tree/main/data/analyst">
`data/analyst` — checks pipelines, writes queries, and verifies recurring reports still hold up.
</Card>
<Card title="Journalist" icon="newspaper" href="https://github.com/nanocoai/nanoclaw-templates/tree/main/media/journalist">
`media/journalist` — monitors a beat, evaluates pitches, finds sources, and preps interviews.
</Card>
</CardGroup>
...
It clones the public catalog, lists what's in it, and copies your pick into your install. Choose the ref you decided on above, for example `sales/sdr`.
...
6. **Your name**, **timezone**, and a **first contact** check.
