...
{/* verified-against: nanoclaw.sh, setup/{auto,templates}.ts, src/templates/{create-agent,local-dir}.ts, src/cli/resources/{groups,tasks}.ts @ nanocoai/nanoclaw#3220 1293ec56 + #2909 5df5800; nanocoai/nanoclaw-templates @ 3c7966a7 */}
