...
{/* verified-against (scoped correction): setup/channels/initial-setup.ts @ b76fcb3d */}
...
7. **Channel** — choose Slack, Mattermost, Teams, Telegram, Discord, WhatsApp, Dial, Signal, iMessage, or another channel. Or skip and use the terminal.
