...
{/* verified-against: src/templates/{create-agent,local-dir,parse}.ts, src/cli/resources/{groups,tasks}.ts @ nanocoai/nanoclaw#3220 1293ec56; setup/{templates,auto}.ts, docs/templates.md @ nanocoai/nanoclaw#2909 5df5800 */}
