...
{/* verified-against: nanocoai/nanoclaw-templates {README.md,scripts/check-templates.mjs,.github/workflows/check-templates.yml} @ 601071b, CONTRIBUTING.md @ nanocoai/nanoclaw-templates#20 282dd29, LICENSE @ 601071b; src/templates/{mcp,manifest,tasks,skills}.ts @ 20d61af. Acceptance/ownership policy is product policy, not code-derived. */}
