...
<Update label="Token count update to 43.0k" description="2026-04-01" tags={["Updated"]}>
  - **Introduction and skills system**: Updated token count from ~42.4k to ~43.0k (22% of context window), matching upstream `repo-tokens/badge.svg`
</Update>
