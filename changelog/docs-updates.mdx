...
<Update label="Post-v2.1.54 sweep: remote MCP, opencode catch-up, CLI reference fixes" description="2026-08-12" tags={["Updated"]}>
  Drift sweep against upstream trunk `639577c3` (38 commits past v2.1.54, no new release) and the providers branch `9cfea509`. Channels branch unchanged.
  ...
  All 36 flagged pages re-verified; stamps bumped to `639577c3` (providers pages to `9cfea509`). Edited prose follows ASD-STE100-aligned style: short sentences, active voice, one instruction per sentence.
</Update>
