...
<Update label="Templates: a new section for the Agent Plugins launch" description="2026-08-12" tags={["New"]}>
  ...
  Verified against `nanocoai/nanoclaw#3220` at `f8563abe` and `#2909` at `ed19f8ea`, plus `nanocoai/nanoclaw-templates@3c7966a7` and [templates#20](https://github.com/nanocoai/nanoclaw-templates/pull/20) at `699fe42` for the registry standards. No product changelog entry yet — the release carrying this format isn't in upstream `package.json`.
</Update>
