...
<Update label="v1.2.35 sync" description="2026-03-27" tags={["Updated"]}>
  - **Installation**: Removed `yaml` and `zod` from dependency listing, pinned `better-sqlite3` and `cron-parser` versions to match upstream
  - **Changelog**: Added v1.2.35 release entry
</Update>
