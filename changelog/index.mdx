...
<Update label="v2.3.0" description="2026-08-24" tags={["Breaking", "Feature", "Fix", "Skill"]}>
  ...
  - **Groups select a runtime tier.** `runtimeTier` (`container` or `vm`) is selected from group config and validated against the driver's isolation capabilities at spawn (#3442)
