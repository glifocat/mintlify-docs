...
<Update label="Unreleased — current main" description="2026-09-05" tags={["Feature", "Fix"]}>
  These changes are verified on upstream `main` at [`b76fcb3d`](https://github.com/nanocoai/nanoclaw/commit/b76fcb3db0236b36a4d50bed02e89eff472d0e67). They are not a new numbered release; the latest release listed below remains v2.3.0.
