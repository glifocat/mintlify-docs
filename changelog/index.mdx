...
<Update label="v1.2.35" description="2026-03-26" tags={["Maintenance"]}>
  - Removed unused dependencies (`yaml`, `zod`, `@vitest/coverage-v8`) — none were imported by the main codebase
</Update>
