...
The vault ships a web dashboard at the same address as `ONECLI_URL` — this is the "OneCLI web UI" the OAuth-based [tool skills](/extend/tools) refer to. Open it in a browser to connect OAuth services (Gmail, Calendar), browse secrets, and watch gateway activity.
