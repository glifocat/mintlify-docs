...
{/* verified-against: container/agent-runner/src/mcp-tools/{index,server,types,core,interactive,agents,self-mod}.ts, container/agent-runner/src/mcp-tools/{core,interactive,agents,self-mod,cli}.instructions.md, src/modules/agent-to-agent/create-agent.ts, src/group-init.ts @ 4e83a0a0 */}
