...
{/* verified-against: src/channels/adapter.ts, src/channels/channel-registry.ts, src/channels/chat-sdk-bridge.ts, src/channels/index.ts, src/webhook-server.ts @ 4e83a0a0; channels branch src/channels/telegram.ts @ 6ee516ad */}
