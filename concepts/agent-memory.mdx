...
{/* verified-against: docs/memory.md, container/agent-runner/src/{index.ts,memory/{scaffold.ts,context.ts,session-hook.ts,templates/index.md,templates/system/{index.md,definition.md}},providers/{types.ts,claude.ts}}, container/skills/self-customize/SKILL.md, .claude/skills/migrate-memory/SKILL.md @ 4e83a0a0 */}
