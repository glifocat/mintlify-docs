...
The main group gets writable access to the store directory (`/workspace/project/store`) so agents can query and write to the SQLite database directly. The rest of the project root remains read-only.
