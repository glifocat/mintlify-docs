...
- **Gateway-based API access**: Containers can make authenticated API requests through the OneCLI gateway (though they cannot extract real credentials)
