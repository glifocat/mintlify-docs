...
{/* verified-against: src/session-manager.ts, src/router.ts, src/channels/channel-defaults.ts, src/container-runner.ts, .claude/skills/manage-channels/SKILL.md, src/cli/resources/wirings.ts @ e926e30e (v2.1.53) */}
