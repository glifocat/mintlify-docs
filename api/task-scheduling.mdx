...
interface ScheduledTask {
  ...
  script?: string | null;               // Optional bash script that runs before waking agent
...
// Timezone for cron expressions (validated IANA identifier, cascading fallback to UTC)
