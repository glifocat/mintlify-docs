...
description: API reference for group registration, retrieval, privilege management, and container configuration
---
...
interface RegisteredGroup {
  ...
  trigger: string;                 // Per-group trigger (e.g., "@Claw"); falls back to default @{ASSISTANT_NAME} if empty
