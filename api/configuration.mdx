...
Each candidate is validated as a real IANA timezone identifier before being accepted. If none are valid, it falls back to `UTC`. This affects cron expression evaluation for scheduled tasks.
