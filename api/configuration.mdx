...
<ParamField path="CREDENTIAL_PROXY_PORT" type="number" default="3001">
  Port for the credential proxy that injects API credentials into container requests.
</ParamField>
...
<ResponseField name="SENDER_ALLOWLIST_PATH" type="string">
  `~/.config/nanoclaw/sender-allowlist.json` - Sender allowlist for trigger authorization
</ResponseField>
