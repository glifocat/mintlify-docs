...
description: Add Discord as a messaging channel for NanoClaw using the /add-discord skill for team collaboration
---
...
<Steps>
  ...
  <Step title="Rebuild and restart">
    ...
    # or: systemctl --user restart nanoclaw-v2-<slug> (Linux)
    ```
  </Step>
</Steps>
