...
- The base NanoClaw codebase stays small (~41.3k tokens)
...
<Warning>
Always build and test after every merge. Auto-merged code can be silently wrong (e.g. referencing a renamed function or using a removed parameter) even when git reports no conflicts. Small frequent merges produce trivial conflicts; large infrequent merges are painful and error-prone.
</Warning>
