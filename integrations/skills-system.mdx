...
- **`/add-atomic-chat-tool`** — Atomic Chat MCP server exposing local OpenAI-compatible models (`127.0.0.1:1337/v1`) as `atomic_chat_list_models` and `atomic_chat_generate` tools
