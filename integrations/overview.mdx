...
tag: "UPDATED"
keywords: ["integrations", "channels", "providers", "skills", "add-telegram", "add-whatsapp", "add-signal", "add-codex", "add-opencode"]
---
...
<CardGroup cols={2}>
  ...
  <Card title="Signal" icon="shield-halved" href="/integrations/signal">
    `/add-signal` — native adapter over a local `signal-cli` TCP daemon
  </Card>
</CardGroup>
