...
<CardGroup cols={2}>
  ...
  <Card title="Slack" icon="hashtag" href="/integrations/slack">
    `/add-slack` — Socket Mode (no public URL required). Marked experimental in the setup picker; a post-install checklist walks you through webhook URL and Event Subscriptions.
  </Card>
</CardGroup>
...
| `/add-imessage` | Apple iMessage | Experimental. Local (macOS) or remote (Photon) mode; local requires Full Disk Access for the node binary |
