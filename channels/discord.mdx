...
{/* verified-against: src/channels/chat-sdk-bridge.ts, src/router.ts, src/channels/channel-defaults.ts, setup/channels/run-channel-skill.ts, .claude/skills/add-discord/SKILL.md @ 4e83a0a0; channels branch src/channels/discord.ts @ 6ee516ad */}
