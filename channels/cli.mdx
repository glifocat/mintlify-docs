...
{/* verified-against: src/channels/cli.ts, src/channels/index.ts, scripts/chat.ts, scripts/init-cli-agent.ts, setup/auto.ts, src/cli/socket-server.ts, package.json @ 639577c3 */}
