...
{/* verified-against: src/channels/{adapter,channel-registry,channel-defaults,index,chat-sdk-bridge,cli}.ts, src/webhook-server.ts, setup/auto.ts, setup/channels/run-channel-skill.ts, .claude/skills/{manage-channels,add-telegram}/SKILL.md @ 4e83a0a0; channels branch src/channels/ @ 6ee516ad */}
