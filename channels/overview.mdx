...
{/* verified-against: src/channels/{adapter,channel-registry,channel-defaults,index,chat-sdk-bridge,cli}.ts, src/webhook-server.ts, setup/auto.ts, setup/channels/run-channel-skill.ts, .claude/skills/{manage-channels,add-telegram}/SKILL.md @ 4446b5bd; channels branch src/channels/ @ c6cdc212 */}
