...
{/* verified-against: .claude/skills/add-{whatsapp-cloud,gchat,github,linear,matrix,webex,wechat,deltachat,emacs,resend}/SKILL.md, src/webhook-server.ts @ 4e83a0a0; channels branch src/channels/{whatsapp-cloud,gchat,github,linear,matrix,webex,wechat,deltachat,emacs,resend}.ts @ 6ee516ad */}
