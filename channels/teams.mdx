...
{/* verified-against: src/channels/chat-sdk-bridge.ts, src/webhook-server.ts, setup/channels/teams-manifest-build.ts, .claude/skills/add-teams/SKILL.md @ 639577c3; channels branch src/channels/teams.ts @ 6ee516ad */}
