...
{/* verified-against: .claude/skills/add-whatsapp/SKILL.md, setup/channels/run-channel-skill.ts @ 4e83a0a0; channels branch src/channels/whatsapp.ts @ 6ee516ad */}
...
<Steps>
  <Step title="Choose your mode">
    The skill starts with a number safety check: will the agent live on your personal number (shared mode — messages land in your "You" self-chat) or on a separate SIM it owns (dedicated mode)? Dedicated mode writes `ASSISTANT_HAS_OWN_NUMBER=true` to `.env`.
  </Step>
