...
{/* verified-against: .claude/skills/add-whatsapp/SKILL.md, setup/channels/run-channel-skill.ts @ e926e30e (v2.1.53); channels branch src/channels/whatsapp.ts @ 6ee516ad */}
