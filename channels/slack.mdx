...
{/* verified-against: src/channels/chat-sdk-bridge.ts, src/webhook-server.ts, src/router.ts, .claude/skills/add-slack/SKILL.md @ 4e83a0a0; channels branch src/channels/slack.ts, container/skills/slack-formatting/SKILL.md @ 6ee516ad */}
