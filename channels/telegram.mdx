...
{/* verified-against: .claude/skills/add-telegram/SKILL.md @ 4e83a0a0; channels branch src/channels/telegram.ts + telegram-pairing.ts + telegram-markdown-sanitize.ts @ 6ee516ad */}
