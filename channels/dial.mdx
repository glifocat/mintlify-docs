...
{/* verified-against: .claude/skills/{add-dial,add-dial-tool}/SKILL.md, setup/pair-dial.ts, setup/auto.ts @ 475ba766; .claude/skills/add-dial-number/SKILL.md @ ee8d9905; channels branch src/channels/dial.ts + dial-pairing.ts @ a45fab71 */}
